$(document).ready(function () {
    ...
    var socket = io.connect('http://localhost:4180');
    ...
    socket.on('output', function (data) {
        ...
        if (data.length) {
            ...
            for (var x = 0; x < data.length; x++) {
                ...
                var generalheading1 = document.createElement('h1');
                ...
                divusercardpoints1.textContent= data[x].year;

                moreinfoheading.textContent = data[x].doctorname;
                coordsspan.textContent = data[x].report;

                generalheading.textContent= data[x].doctorname;
                generalpara.textContent = data[x].hospitalname;
                generalheading1.textContent= data[x].reportname;

                generalspan.textContent = "Report detailes";
                ...
                divgeneral.appendChild(generalheading1);
